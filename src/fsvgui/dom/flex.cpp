...
#include "elements.h"    // for Element, unpack, filler, flex, flex_grow, flex_shrink, notflex, xflex, xflex_grow, xflex_shrink, yflex, yflex_grow, yflex_shrink
#include "node.h"        // for Elements, Node
...
{
public:
    explicit Flex(FlexFunction f) :
        f_(f) { }
    Flex(FlexFunction f, Element child) :
