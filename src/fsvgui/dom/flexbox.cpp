...
#include "elements.h"       // for Element, Elements, flexbox, hflow, vflow
#include "flexbox_config.h" // for FlexboxConfig, FlexboxConfig::Direction, FlexboxConfig::Direction::Column, FlexboxConfig::AlignContent, FlexboxConfig::Direction::ColumnInversed, FlexboxConfig::Direction::Row, FlexboxConfig::JustifyContent, FlexboxConfig::Wrap, FlexboxConfig::AlignContent::FlexStart, FlexboxConfig::Direction::RowInversed, FlexboxConfig::JustifyContent::FlexStart, FlexboxConfig::Wrap::Wrap
#include "flexbox_helper.h" // for Block, Global, Compute
#include "node.h"           // for Node, Elements, Node::Status
...
public:
    ...
    {
        return config_.direction == FlexboxConfig::Direction::Column || config_.direction == FlexboxConfig::Direction::ColumnInversed;
    }
    ...
    void SetBox(Box box) override
    {
        ...
        asked_                   = std::min(asked_, IsColumnOriented() ? box.y_max - box.y_min + 1 : box.x_max - box.x_min + 1);
