...
{
    public:
        RuleSlot(const Rule* p_rule, SlotType p_slotType) : m_rule(p_rule), m_type(p_slotType) {}
        const Rule* m_rule;
        SlotType m_type;
};
...
{
    public:
        AndRule(const std::string& p_name, Grammar& p_grammar) : Rule(p_name, p_grammar, RuleType::And)
        {}
...
{
    public:
        OrRule(const std::string& p_name, Grammar& p_grammar) : Rule(p_name, p_grammar, RuleType::Or)
        {}
